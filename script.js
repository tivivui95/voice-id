(async () => {
  ...
  function loadURLToInputFiled(url){
    getImgURL(url, (imgBlob)=>{
      ...
      let file = new File([imgBlob], fileName,{type:"audio/wav", lastModified:new Date().getTime()});
      let container = new DataTransfer(); 
      container.items.add(file);
      document.querySelector('#wav_file').files = container.files;
